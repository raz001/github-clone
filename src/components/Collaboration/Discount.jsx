    ...
    <div className='lg:pl-24 md:pl-16 pl-6'>
        ...
        <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{type:'tween', duration:0.3}} className='mb-10 md:mb-32 pb-4 '>
            <div className='py-4 text-left'>
                ...
                <h3 className="text-[#ffa28b] mb-2 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">80%</h3>
                <p className="mb-3 md:text-xl text-base font-medium text-white">reduction in onboarding time with GitHub<sup>2</sup></p>
            </div>
        </motion.div>
    </div>
  </div>
