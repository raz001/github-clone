    ...
    <div className='max-w-[1280px] mx-auto'>
        ...
        <div className='relative z-[1]'>
            ...
            <div className='overflow-auto md:flex flex-col md:space-y-20 flex-1 py-20 md:p-10 p-5 my-6    justify-between md:min-w-[400px]'>
                ...
                <div>
                    <a href="#" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} className='py-1 inline-block text-xl text-white font-semibold'>
            ...
            <motion.div initial={{scale:0.9, opacity:0}} whileInView={{scale:1, opacity:1}} transition={{type:'tween'}} className='rounded-r-md overflow-hidden flex items-center'>
                {/* <img className="responsive js-build-in-item build-in-scale-fade build-in-animate origin-bottom-right" width="1288" height="992" loading="lazy" decoding="async" alt="" aria-hidden="true" src="" /> */}
            </motion.div>
            </HoverCard>
        </div>
